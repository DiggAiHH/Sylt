              ...
              <div className="flex gap-4 mt-6">
                {socialLinks.instagram && (
                  <a
                    ...
                    className="text-sand-300 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-sand-300 rounded-full p-1"
                ...
                {socialLinks.pinterest && (
                  <a
                    ...
                    rel="noopener noreferrer"
                    className="text-sand-300 hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-sand-300 rounded-full p-1"
                    aria-label="Besuchen Sie uns auf Pinterest (öffnet in neuem Tab)"
                  >
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
