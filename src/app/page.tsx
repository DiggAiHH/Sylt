      ...
      <section className="bg-gradient-to-b from-deep-sea-blue to-deep-sea-blue-700 text-white py-28 md:py-32">
        <div className="max-w-5xl mx-auto px-6 text-center">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6">
            ...
            <a
              href="#marken"
              className="inline-flex items-center px-8 py-4 bg-rich-gold text-deep-sea-blue text-lg font-bold rounded-xl hover:bg-rich-gold transition-all duration-300 hover:scale-105 shadow-lg min-h-[56px] focus:ring-4 focus:ring-white focus:ring-offset-2 focus:ring-offset-deep-sea-blue"
            >
            ...
            <Link
              href="/kochbuch"
              className="inline-flex items-center px-8 py-4 bg-white text-deep-sea-blue text-lg font-bold rounded-xl hover:bg-rich-gold hover:text-deep-sea-blue transition-all duration-300 hover:scale-105 shadow-lg min-h-[56px] focus:ring-4 focus:ring-white focus:ring-offset-2 focus:ring-offset-deep-sea-blue"
            >
