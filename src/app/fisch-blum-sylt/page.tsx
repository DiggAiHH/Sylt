...
export const metadata: Metadata = {
  title: "Fisch Blum Sylt - Premium Fischerzeugnisse | BLUM",
  description: "Unter der Marke Fisch Blum Sylt bieten wir feinste Fischerzeugnisse aus der Nordsee. DPMA-geschützte Marke der Klasse 29.",
};

export default function FischBlumSyltPage() {
  return (
    <div className="bg-sand-light">
      {/* Hero Section */}
      <section className="bg-gradient-to-b from-nordsee to-nordsee-dark text-white py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-block bg-white/10 px-4 py-2 rounded-full">
            <span className="text-sm text-sand-light">Klasse 29: Fischerzeugnisse</span>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-none">
            <p className="text-xl text-reetdach leading-relaxed mb-8">
              Unter der Marke <strong className="text-nordsee-dark">Fisch Blum Sylt</strong> werden 
              feinste Fischerzeugnisse aus der Nordsee angeboten. Die Marke steht für traditionelle 
              Handwerkskunst, nachhaltige Fischerei und die einzigartige Qualität, die nur die 
              Gewässer rund um Sylt bieten können.
            </p>
            ...
            <div className="bg-sand-light rounded-lg p-6 mb-8">
              <dl className="space-y-4">
                <div>
                  ...
                  <dd className="text-lg font-medium text-nordsee-dark">Fisch Blum Sylt</dd>
                </div>
                <div>
                  <dt className="text-sm text-reetdach-light">Waren-/Dienstleistungsklasse</dt>
                  <dd className="text-lg font-medium text-nordsee-dark">Klasse 29 - Fischerzeugnisse</dd>
                </div>
              </dl>
            </div>
            ...
            <ul className="space-y-3 text-reetdach">
              <li className="flex items-center">
                <span className="w-2 h-2 bg-nordsee rounded-full mr-3"></span>
              ...
              <li className="flex items-center">
                <span className="w-2 h-2 bg-nordsee rounded-full mr-3"></span>
                Marinierte Fischprodukte
              </li>
              <li className="flex items-center">
                <span className="w-2 h-2 bg-nordsee rounded-full mr-3"></span>
                Fischkonserven in Premium-Qualität
              </li>
            </ul>
          </div>
        </div>
